...
<body>
    ...
    <section class="Homepage">
        <div class="centent">
            ...
            ?>
            <!-- <div class="left-box bg-img" style="background-image: url('https://cdn.sabay.com/cdn/media.sabay.com/media/Samphy-2023/December/Week-(25)/656ea0c104a17_1701748920_medium.jpg'); background-position: center; background-repeat: no-repeat; background-size: cover;">
                <div class="box-title">
                    កម្សាន្ត
                </div>
                <h4>អ្នកឧកញ៉ា វេជ្ជបណ្ឌិត គួច ម៉េងលី ៖ ជំនាញឌីជីថល ពិតជាសំខាន់ មិនអាចខ្វះបានសម្រាប់សម័យកាលនេះ
    ...
    <section class="content2">
        ...
        <div class="content-item">
            ...
            ?>
            <?php
            $se = "SELECT * FROM `tbl_categorynew` WHERE menuID='KS' and remark='Active'";
            $rs = $con->query($se);
            while ($rownew = $rs->fetch_assoc()) {
            ?>
                <div class="item2" style="margin-left: 0px;">
    ...
    <section class="content2">
        ...
        <div class="ads-box">
            ...
            <div class="content-item">
                ...
                <!-- <div class="item2" style="margin-left: 0px;">
                    <div class="pic">
                        <img src="https://cdn.sabay.com/cdn/media.sabay.com/media/sabay-news/Technology-News/Long-Tech/F52/6544cef16c024_1699008240_medium.jpg" alt="">
                    </div>
                    <div class="title1">
                        <p>អ្វីដែលរឹតតែពិសេសទៅទៀតនោះ Velea ក៏មាន Workshop ឥតគិតថ្លៃផ្សេងៗ ដូចជា</p>
                    </div>
